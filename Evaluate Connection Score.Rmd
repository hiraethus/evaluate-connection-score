...
This document attempts to establish the properties of varying cerain properties of unordered query gene signatures in performing Connectivity Map. For details of the connectivity map method employed, see [@zhang2008simple].
